...
public class LoggingAspectConfiguration {
    private final Map<String, LoggingLevel> loggerCredentials;

    private static final Map.Entry<String, LoggingLevel> DEFAULT_LOGGER_LEVEL = new AbstractMap.SimpleEntry<>("level", LoggingLevel.SHORT);

    public LoggingAspectConfiguration(Map<String, LoggingLevel> loggerCredentials) {
